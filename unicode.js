...
let swappedString = String.fromCharCode(codes2[5]) +
 String.fromCharCode(codes2[1]) +
 String.fromCharCode(codes2[2]) +
 String.fromCharCode(codes2[3]) +
 String.fromCharCode(codes2[4]) +
 String.fromCharCode(codes2[0]);
